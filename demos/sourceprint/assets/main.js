...
function renderDetails() {
	...
	$("#mainTitle").html("<div id='box'>"+symbol+"</div><a href='http://sourcemap.com/view/"+smap_id+"'>"+data.details.title+"</a> ("+data.details.owner.name.properize()+" Sourcemap)");
	$("#details").append("<img id='mapPreview' src='http://sourcemap.com/static/"+smap_id+".m.png'/>");
	$("#details").append("<img id='userimage' src='"+data.details.owner.avatar+"'/>");					
	$("#byLine").text();		
